...
This is the full first-run walkthrough. Most users only need `pip install context-os && contextos install` — but if you want to know exactly what's happening, this is the doc.
...
Then `pip uninstall context-os` to remove the package itself.
